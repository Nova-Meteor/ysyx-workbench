...
void Vswitch___024root___eval(Vswitch___024root* vlSelf) {
    ...
    do {
        if (VL_UNLIKELY(((0x00000064U < __VicoIterCount)))) {
            ...
            Vswitch___024root___dump_triggers__ico(vlSelfRef.__VicoTriggered, "ico"s);
#endif
            VL_FATAL_MT("vsrc/switch.v", 1, "", "DIDNOTCONVERGE: Input combinational region did not converge after '--converge-limit' of 100 tries");
        }
        __VicoIterCount = ((IData)(1U) + __VicoIterCount);
        vlSelfRef.__VicoPhaseResult = Vswitch___024root___eval_phase__ico(vlSelf);
